...
+
----
Micronaut: (52 + 45 + 47 + 46 + 47) / 5 = 47.4
Quarkus: (45 + 41 + 42 + 44 + 49) / 5 = 44.2
Spring Boot: (55 + 72 + 62 + 52 + 52) / 5 = 58.6
Helidon: (183 + 265 + 177 + 386 + 303) / 5 = 262.8
----
...
|Micronaut | `./micronaut/build/native/nativeCompile/app` | 47.4
|Quarkus | `./quarkus/build/quarkus-1.0.0-SNAPSHOT-runner` | 44.2
|Spring Boot | `./spring-boot/build/native/nativeCompile/spring-boot` | 58.6
|Helidon | `./helidon/target/helidon` | 262.8
|===
...
|===
|Framework | Executable | Megabytes after startup | Megabytes after 1 request| Megabytes after 10K requests

|Micronaut | `app` | 53 | 62 | 102
|Quarkus | `quarkus` | 49 | 50 | 53
|Spring Boot | `spring-boot` | 75 | 107 | 174
|Helidon | `helidon` | 44 | 45 | 68
|===
